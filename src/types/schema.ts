...
export class WannaSwapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save WannaSwapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save WannaSwapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("WannaSwapFactory", id.toString(), this);
  }

  static load(id: string): WannaSwapFactory | null {
    return store.get("WannaSwapFactory", id) as WannaSwapFactory | null;
  }
...
export class WannaSwapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save WannaSwapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save WannaSwapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("WannaSwapDayData", id.toString(), this);
  }

  static load(id: string): WannaSwapDayData | null {
    return store.get("WannaSwapDayData", id) as WannaSwapDayData | null;
  }
